...
const atualizarClassificacao = async function (classificacao, id, contentType) {
    ...
    try {
        ...
        // Chama a função de validar os dados da classificacao
        let falha = await verificarFalhas(classificacao)
        if (falha.length) {
            return falha                                                        //400 referente a dados de input(classificacao)
        }

        //Verificando existencia da classificacao
        ...
        //Chama a função para inserir a nova classificacao no DB
...
// Função reutilizável para validação de dados de cadastro e atualização da classificacao
